   ...
   //restart testy
    ...
    func nextQuestion() {
        ...
        if questionNumber  < 20{
            ...
            questionImage.image = UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_bg")
            
        buttonAnswerA.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_A"), for: .normal)
            
            buttonAnswerB.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_B"), for: .normal)
            
            buttonAnswerC.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_C"), for: .normal)
            
            buttonAnswerD.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_D"), for: .normal)
            
            buttonAnswerE.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_E"), for: .normal)
            
            buttonAnswerF.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_F"), for: .normal)
            ...
            buttonAnswerG.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_G"), for: .normal)
  
            buttonAnswerH.setImage(UIImage(named: "raven/test-de-raven-\(String(allQuestions.list[questionNumber].nrQuestion))_H"), for: .normal)
            }
